...
$titulo = ($esNuevo==1)?'Nuevo Tipo Antivirus':'Editando Tipo Antivirus';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <h1><?=$titulo?></h1>
    <form action="?ctrl=CtrlSwAntivirus&accion=guardar" method="post">
    ...
    <a href="?ctrl=CtrlSwAntivirus">Retornar</a>
</body>
</html>